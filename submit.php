...
?>
<script type="text/javascript">alert ("Thank you, your information is registered!! "); window.location = "gr.html"</script>
<?php
}
}
}
...
<div class="container" >
	...
	<input type="tel" pattern="[0-9]{2}-[0-9]{5}" class="qr-studnum" placeholder="SN NO. 00-00000" name="stu_id" onkeydown="return/[0-9-]/i.test(event.key)" maxlength="9" required >
	<br>
